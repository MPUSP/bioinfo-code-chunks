...
- or using using conda/mamba, or the pixi environment manager
...
- `circlize_plot` takes as input two objects, a DNA sequence as `DNAStringSet` and a `GRangesList` with genomic features
